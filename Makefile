...
ACLOCAL = ${SHELL} /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip/build-aux/missing aclocal-1.15
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
ASFLAGS_config = 
ASM_SYMBOL_PREFIX = ""
AUTOCONF = ${SHELL} /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip/build-aux/missing automake-1.15
AWK = mawk
BITSIZEOF_PTRDIFF_T = 
...
GNULIB_WARN_CFLAGS =  -fno-common -W -Wabi -Waddress -Waggressive-loop-optimizations -Wall -Wattributes -Wbad-function-cast -Wbool-compare -Wbuiltin-macro-redefined -Wcast-align -Wchar-subscripts -Wchkp -Wclobbered -Wcomment -Wcomments -Wcoverage-mismatch -Wcpp -Wdate-time -Wdeprecated -Wdeprecated-declarations -Wdesignated-init -Wdisabled-optimization -Wdiscarded-array-qualifiers -Wdiscarded-qualifiers -Wdiv-by-zero -Wdouble-promotion -Wempty-body -Wendif-labels -Wenum-compare -Wextra -Wformat-contains-nul -Wformat-extra-args -Wformat-security -Wformat-signedness -Wformat-y2k -Wformat-zero-length -Wfree-nonheap-object -Wignored-qualifiers -Wimplicit -Wimplicit-function-declaration -Wimplicit-int -Wincompatible-pointer-types -Winit-self -Wint-conversion -Wint-to-pointer-cast -Winvalid-memory-model -Winvalid-pch -Wjump-misses-init -Wlogical-not-parentheses -Wmain -Wmaybe-uninitialized -Wmemset-transposed-args -Wmissing-braces -Wmissing-declarations -Wmissing-field-initializers -Wmissing-include-dirs -Wmissing-parameter-type -Wmultichar -Wnarrowing -Wnonnull -Wodr -Wold-style-declaration -Wopenmp-simd -Woverflow -Woverlength-strings -Woverride-init -Wpacked -Wpacked-bitfield-compat -Wparentheses -Wpointer-arith -Wpointer-sign -Wpointer-to-int-cast -Wpragmas -Wpsabi -Wreturn-local-addr -Wreturn-type -Wsequence-point -Wshift-count-negative -Wshift-count-overflow -Wsizeof-array-argument -Wsizeof-pointer-memaccess -Wstrict-aliasing -Wstrict-prototypes -Wsuggest-attribute=const -Wsuggest-attribute=format -Wsuggest-attribute=noreturn -Wsuggest-attribute=pure -Wsuggest-final-methods -Wsuggest-final-types -Wswitch -Wswitch-bool -Wsync-nand -Wtrampolines -Wtrigraphs -Wtype-limits -Wunknown-pragmas -Wunused -Wunused-but-set-parameter -Wunused-but-set-variable -Wunused-function -Wunused-label -Wunused-local-typedefs -Wunused-parameter -Wunused-result -Wunused-value -Wunused-variable -Wvarargs -Wvariadic-macros -Wvector-operation-performance -Wvolatile-register-var -Wwrite-strings -Warray-bounds=2 -Wnormalized=nfc -Wno-sign-compare -Wno-unused-parameter -Wsuggest-attribute=const -Wsuggest-attribute=noreturn -Wno-format-nonliteral -Wsuggest-attribute=pure -Wno-logical-op -fdiagnostics-show-option -funit-at-a-time
GNULIB_WCPCPY = 0
GNULIB_WCPNCPY = 0
GNULIB_WCRTOMB = 0
GNULIB_WCSCASECMP = 0
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip/build-aux/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
WINT_T_SUFFIX = 
abs_builddir = /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip
abs_srcdir = /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip
abs_top_builddir = /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip
abs_top_srcdir = /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  asnprintf.o chdir-long.o fclose.o fcntl.o fflush.o fprintf.o fpurge.o fseek.o fseeko.o fseterr.o localtime-buffer.o openat-proc.o printf.o printf-args.o printf-parse.o strerror_r.o vasnprintf.o vfprintf.o
gl_LTLIBOBJS =  asnprintf.lo chdir-long.lo fclose.lo fcntl.lo fflush.lo fprintf.lo fpurge.lo fseek.lo fseeko.lo fseterr.lo localtime-buffer.lo openat-proc.lo printf.lo printf-args.lo printf-parse.lo strerror_r.lo vasnprintf.lo vfprintf.lo
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
...
install_sh = ${SHELL} /media/psf/Home/Desktop/new_new_gzip/parallelized-gzip/build-aux/install-sh
...
gzip_LDADD = libver.a lib/libgzip.a -lz $(LIB_CLOCK_GETTIME)
SUFFIXES = .in
