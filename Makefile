...
am_gzip_OBJECTS = bits.$(OBJEXT) deflate.$(OBJEXT) gzip.$(OBJEXT) \
	...
	unzip.$(OBJEXT) util.$(OBJEXT) zip.$(OBJEXT) utils.$(OBJEXT)
gzip_OBJECTS = $(am_gzip_OBJECTS)
am__DEPENDENCIES_1 =
gzip_DEPENDENCIES = libver.a lib/libgzip.a -lz $(am__DEPENDENCIES_1)
...
am__depfiles_remade = ./$(DEPDIR)/bits.Po ./$(DEPDIR)/deflate.Po \
	...
	./$(DEPDIR)/version.Po ./$(DEPDIR)/zip.Po ./$(DEPDIR)/utils.Po
am__mv = mv -f
...
ACLOCAL = ${SHELL} /media/psf/Home/Downloads/gzip-1.9/build-aux/missing aclocal-1.15a
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
ASFLAGS_config = 
ASM_SYMBOL_PREFIX = ""
AUTOCONF = ${SHELL} /media/psf/Home/Downloads/gzip-1.9/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/psf/Home/Downloads/gzip-1.9/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/psf/Home/Downloads/gzip-1.9/build-aux/missing automake-1.15a
AWK = mawk
BITSIZEOF_PTRDIFF_T = 
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /media/psf/Home/Downloads/gzip-1.9/build-aux/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
WINT_T_SUFFIX = 
abs_builddir = /media/psf/Home/Downloads/gzip-1.9
abs_srcdir = /media/psf/Home/Downloads/gzip-1.9
abs_top_builddir = /media/psf/Home/Downloads/gzip-1.9
abs_top_srcdir = /media/psf/Home/Downloads/gzip-1.9
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /media/psf/Home/Downloads/gzip-1.9/build-aux/install-sh
...
gzip_SOURCES = \
  ...
  trees.c unlzh.c unlzw.c unpack.c unzip.c util.c zip.c utils.c
